...
PerspectiveCamera::PerspectiveCamera(py::tuple eye, py::tuple center, py::tuple up, float fov_rad, float aspect_ratio)
{
    look_at(eye, center, up);
    _fov_rad = fov_rad;
    _aspect_ratio = aspect_ratio;
}
PerspectiveCamera::PerspectiveCamera(float fov_rad, float aspect_ratio)
{
    float eye[3] = { 0, 0, 1 };
    float center[3] = { 0, 0, 0 };
    float up[3] = { 0, 1, 0 };
